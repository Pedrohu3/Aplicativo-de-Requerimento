...
import universidade from '../assets/universidade.jpg'

export default function AuthLayout({ children }) {
  return (
    <div className="flex min-h-screen bg-gray-light">
      {/* Painel esquerdo */}
      <div className="hidden w-[420px] shrink-0 flex-col border-r border-gray-light bg-white lg:flex">
        {/* Logo */}
        <div className="flex flex-col items-center border-b border-gray-light px-8 py-8">
        ...
        <div className="flex flex-1 flex-col justify-center px-8 py-6">
          <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-primary-50">
            <svg className="h-6 w-6 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
          </div>

          <h2 className="text-2xl font-bold leading-snug text-primary-700">
        ...
        <p className="border-t border-gray-light px-8 py-4 text-xs text-gray-mid">
      ...
      <div
        className="relative flex flex-1 flex-col items-center justify-center overflow-hidden bg-cover bg-center px-6 py-10"
        style={{ backgroundImage: `url(${universidade})` }}
      >
        <div className="absolute inset-0 bg-slate-900/45" />
        <div className="relative z-10 mb-6 flex justify-center lg:hidden">
