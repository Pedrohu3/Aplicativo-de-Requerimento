...
public class RequerimentoController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<RequerimentoResponse> atualizar(
            @PathVariable Long id,
            @Valid @RequestBody RequerimentoRequest request
    ) {
        return ResponseEntity.ok(requerimentoService.atualizar(id, request));
    }
